...
totalPrice1 = totalPrice + productPrice1 * productQuantity1;
totalPrice2 = totalPrice + productPrice2 * productQuantity2;
totalPrice3 = totalPrice + productPrice3 * productQuantity3;
globalPrice = totalPrice1 + totalPrice2 + totalPrice3;

alert(`Сума за А4 ${totalPrice1}`);

alert(`Сума за биндери ${totalPrice2}`);

alert(`Сума за синю ручку ${totalPrice3}`);

alert(`Загальна сума ${globalPrice}`);
